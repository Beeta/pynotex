"""
Prompt templates for Notex (对应 Go 的 prompt.go)
包含 12 种内容转换类型的提示词模板
"""
...
def get_transformation_prompt(transform_type: str) -> str:
    ...
    return prompts.get(transform_type, default_prompt())
...
def ppt_prompt() -> str:
    # PPT prompt 非常长 (210-390 行)，这里是完整的 PPT 提示词
    return """# 演示文稿设计指令
